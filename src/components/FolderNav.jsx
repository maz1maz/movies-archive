      ...
      <div className="folder-nav-content">
        <div className="marquee-band">
          ...
          <div className="folder-grid">
            ...
            <button className="folder-card reveal-item reveal-5" onClick={onSelectDigital}>
              <span className="folder-icon">
            ...
            <button className="folder-card folder-card-dashboard reveal-item reveal-6" onClick={onSelectDashboard}>
              <span className="folder-icon">
          ...
          <p className="marquee-footer reveal-item reveal-7">Admit one · no refunds · enjoy the show</p>
        </div>
      </div>
    </div>
  )

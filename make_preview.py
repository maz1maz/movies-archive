  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .modal-cine { position: relative; width: min(680px, 92vw); max-height: 90vh; overflow-y: auto; background: #232631; border: 1px solid #383b50; border-radius: 16px; padding: 22px 24px; box-shadow: 0 24px 60px rgba(0,0,0,0.7); display: flex; flex-direction: column; gap: 16px; color: #f8fafc; }
      ...
      .cine-poster-box { position: relative; width: 155px; flex: 0 0 auto; aspect-ratio: 2 / 3; border-radius: 10px; overflow: hidden; background: #1e293b; border: 1px solid #383b50; box-shadow: 0 8px 20px rgba(0,0,0,0.4); }
      ...
      .cine-info-card { flex: 1 1 auto; background: #2b2e3b; border: 1px solid #383b50; border-radius: 12px; padding: 16px 18px; display: flex; flex-direction: column; justify-content: space-between; gap: 16px; }
      ...
      /* IMDb Yellow Badge (All Black text, /10, K Votes & Clickable) */
      .imdb-badge-cine { display: inline-flex; flex-direction: column; align-items: center; justify-content: center; background: linear-gradient(135deg, #f5c518, #eab308); color: #000000 !important; border-radius: 6px; padding: 4px 10px; text-decoration: none; box-shadow: 0 2px 8px rgba(245,197,24,0.4); }
      ...
      .imdb-badge-votes { color: #000000 !important; font-size: 10px; font-weight: 800; opacity: 0.9; margin-top: 2px; font-family: monospace; letter-spacing: 0.2px; text-transform: uppercase; }
      ...
      .cine-trailer-card { display: block; text-decoration: none; border-radius: 10px; overflow: hidden; border: 1px solid #383b50; transition: transform 0.15s; }
      ...
      /* Person Modal */
      .modal-person { position: relative; width: min(720px, 94vw); max-height: 88vh; overflow-y: auto; background: #232631; border: 1px solid #383b50; border-radius: 16px; padding: 24px; box-shadow: 0 24px 60px rgba(0,0,0,0.75); display: flex; flex-direction: column; gap: 20px; color: #f8fafc; }
      ...
      .person-film-card { background: #2b2e3b; border: 1px solid #383b50; border-radius: 12px; overflow: hidden; cursor: pointer; padding: 0; text-align: left; transition: transform .15s, border-color .15s; color: inherit; display: flex; flex-direction: column; }
...
with open("preview.html", "w", encoding="utf-8") as f:
    f.write(html)
print("preview.html updated with K-formatted vote counts and strict black text for IMDb badge")
